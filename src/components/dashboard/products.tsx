...
export default function ProductsPage() {
  ...
  const fetchProducts = async (pageNumber: number) => {
    ...
    try {
      ...
      const res = await productsApi.list({ page: pageNumber, limit }) as ProductsResponse & {
  ...
  const saveEdit = async () => {
    ...
    try {
      ...
      if (isNewProduct) {
        ...
        void _id;
        void id;
        const res = await productsApi.create(payload) as {
          data: ProductType;
        };
        ...
        await productsApi.update(editedProduct._id, editedProduct);
